...
* Bu uygulama su satışlarını takip edilebilmesi amacıyla tasarlanmıştır. Müşterilerin bilgilerini ve siparişlerini takip etmeyi amaçlamaktadır. Bu program Java dilinde yazılmıştır ve veri tabanı olarak SQLite kullanılmıştır. Arayüz tasarımında **JFrame** kullanılmıştır. Geliştirme ortamı olarak **Netbeans** seçildi.
